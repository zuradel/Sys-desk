...
const SD_MODELS = [
  ...
  { name:'SOPMOD-II 🔥',
    ...
    greeting:_t('model_greeting_sopmod'), hasSound:false, scale:1.0, vOffset:0, hOffset:50, bubbleGap:-110 },
  { name:'HK416 🎯',
    ...
    greeting:_t('model_greeting_hk416'), hasSound:false, scale:0.9, vOffset:-20, hOffset:10, bubbleGap:-90 },
  { name:'K2 🌸',
    path:'https://cdn.jsdelivr.net/gh/evrstr/live2d-widget-models/live2d_evrstr/k2_3301/model.json',
    greeting:_t('model_greeting_k2'), hasSound:false, scale:1.0, vOffset:0, hOffset:30, bubbleGap:-100 },
  { name:'PKP 🍵',
